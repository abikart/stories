...
Story matte: <exact #RRGGBB from stage.backdrop.color; default #FFFFFF>
...
Scale and framing: <physical anchors that establish character size; the
  character-level slice of the location; eye-level or slightly low camera; how
  white space isolates the action>
...
Lighting: <soft diffuse time-of-day treatment that does not tint the solid matte>
Must preserve: <character anatomy, accessories, exact wing count, prop state,
  and elements that must not transform in this beat>
Avoid: gradient or textured matte, any color drift from the declared matte,
  paper/canvas texture, full-bleed scenery, uniform
...
- Inspect every outer edge for the exact declared matte color, with no gradient,
  grain, cast, hard rectangle, or video-compression fringe.
